...
async function connectToWhatsApp() {
    ...
    if (!iky.authState.creds.registered) {
        ...
        rl.question('Please enter your WhatsApp number (Example: 628xxxxxx): ', async (number) => {
            let phoneNumber = number.replace(/[^0-9]/g, '');
 
            if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
                console.log("Start with country code of your WhatsApp number, (Example: 628xxxxxx)");
                process.exit(0);
            }
